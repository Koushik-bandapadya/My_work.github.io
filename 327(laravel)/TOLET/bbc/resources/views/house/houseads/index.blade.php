...
<div>
<form action="{{route('houseads.create')}}">
...
<table style="width:100%">
      ...
      <tr>
        ...
        <td> <button type="button" ><a href="{{route('houseads.edit',$row->id)}}">Edit</a>  </button> </td>
        <td>  
       <form action="{{route('houseads.destroy',$row->id)}}" method ="POST" onsubmit="return confirm('Are you sure !')">
        @csrf
        @method('delete')
